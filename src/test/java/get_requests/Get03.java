...
public class Get03 extends JsonPlaceHolderBaseUrl {
    ...
    public void get03() {
        ...
        // body() method'uyla biz bodynin icindeki bilgilere ulasmis olucaz.

        // equalTo()  hamcrest matchers library'den geliyor.
        //2nd Way:
        response.
                then().
                statusCode(200).
                contentType(ContentType.JSON).  // recommended way
                body("title", equalTo("et itaque necessitatibus maxime molestiae qui quas velit"),
        ...
        "Soft Assertion"i sadece body icinde yapabiliyoruz.
         */

        /*
           Tek body() methodu icerisinde coklu "assertion" yaparak "soft assertion" olusturabilirsiniz.
           Fail durumunda body() icerisinde Java calismayi durdurmaz.

           Coklu body() methodu ile "assertion" yapildiginda fail durumunda
           Java bir sonraki body() methodu oncesi calismayi durdurur.
